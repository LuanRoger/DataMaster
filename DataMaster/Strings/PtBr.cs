    ...
    public void InitLanguage()
    {
        language = new(LanguageCode.PT_BR, new()
        {
            ...
            {"MessageBox", new()
            {
                ...
                {"SelectTableToInsert", "Selecione um banco de dados para inserir a tabela."},
                {"ColumnNameType", "A coluna deve ter um nome e um tipo de dados."},
                {"SelectTableDelete", "Selecione uma coluna para excluir."},
